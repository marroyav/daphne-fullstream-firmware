...
set eth_clk_n [create_bd_port -dir I -type clk -freq_hz 100000000 eth_clk_n]
set eth_clk_p [create_bd_port -dir I -type clk -freq_hz 100000000 eth_clk_p]
set_property CONFIG.ASSOCIATED_RESET {AFE_RST} $eth_clk_p
set RX_GTH_n [create_bd_port -dir I -from 3 -to 0 RX_GTH_n]
set RX_GTH_p [create_bd_port -dir I -from 3 -to 0 RX_GTH_p]
...
set TX_GTH_n [create_bd_port -dir O -from 3 -to 0 TX_GTH_n]
set TX_GTH_p [create_bd_port -dir O -from 3 -to 0 TX_GTH_p]
set GTH_TX_DIS [create_bd_port -dir O -from 3 -to 0 GTH_TX_DIS]
...
# create instance: I2C_RESET
set I2C_RESET [create_bd_cell -vlnv xilinx.com:ip:proc_sys_reset:5.0 -type IP I2C_RESET]

# create instance: PL_I2C
set PL_I2C [create_bd_cell -vlnv xilinx.com:ip:axi_iic:2.1 -type IP PL_I2C]

# create instance: CM_SPI
set CM_SPI [create_bd_cell -vlnv xilinx.com:ip:axi_quad_spi:3.2 -type IP CM_SPI]
# set_property CONFIG.C_BYTE_LEVEL_INTERRUPT_EN {0} $axi_quad_spi_0

# create instance: INTERUPTS, and set its properties
set INTERUPTS [create_bd_cell -vlnv xilinx.com:ip:axi_intc:4.1 -type IP INTERUPTS]
set_property CONFIG.C_IRQ_CONNECTION {1} $INTERUPTS
...
connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports IIC_0] [get_bd_intf_pins PL_I2C/IIC]
...
connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins DAPHNE3/END_P_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins DAPHNE3/FRONT_END_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins DAPHNE3/OUTBUFF_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins DAPHNE3/SPI_DAC_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins smartconnect_0/M05_AXI] [get_bd_intf_pins DAPHNE3/SPY_BUF_S_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins smartconnect_0/M06_AXI] [get_bd_intf_pins DAPHNE3/STUFF_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M07_AXI [get_bd_intf_pins smartconnect_0/M07_AXI] [get_bd_intf_pins DAPHNE3/TRIRG_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M08_AXI [get_bd_intf_pins PL_I2C/S_AXI] [get_bd_intf_pins smartconnect_0/M08_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M09_AXI [get_bd_intf_pins CM_SPI/AXI_LITE] [get_bd_intf_pins smartconnect_0/M09_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M10_AXI [get_bd_intf_pins INTERUPTS/s_axi] [get_bd_intf_pins smartconnect_0/M10_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M11_AXI [get_bd_intf_pins DAPHNE3/MUX_S_AXI] [get_bd_intf_pins smartconnect_0/M11_AXI]
...
connect_bd_net -net DAPHNE3_DIN_DEBUG [get_bd_pins DAPHNE3/DIN_DEBUG] [get_bd_pins ila_0/probe3]
connect_bd_net -net DAPHNE3_LAST_DEBUG [get_bd_pins DAPHNE3/LAST_DEBUG] [get_bd_pins ila_0/probe5]
connect_bd_net -net DAPHNE3_VALID_DEBUG [get_bd_pins DAPHNE3/VALID_DEBUG] [get_bd_pins ila_0/probe4]
...
connect_bd_net -net DAPHNE3_eth_tx_dis [get_bd_pins DAPHNE3/eth_tx_dis] [get_bd_ports GTH_TX_DIS]
connect_bd_net -net DAPHNE3_eth_tx_n [get_bd_pins DAPHNE3/eth_tx_n] [get_bd_ports TX_GTH_n]
connect_bd_net -net DAPHNE3_eth_tx_p [get_bd_pins DAPHNE3/eth_tx_p] [get_bd_ports TX_GTH_p]
...
connect_bd_net -net DAPHNE3_out_buff_clk [get_bd_pins DAPHNE3/out_buff_clk] [get_bd_pins ila_0/probe1]
connect_bd_net -net DAPHNE3_out_buff_data [get_bd_pins DAPHNE3/out_buff_data] [get_bd_pins ila_0/probe2]
connect_bd_net -net DAPHNE3_out_buff_trig [get_bd_pins DAPHNE3/out_buff_trig] [get_bd_pins ila_0/probe0]
...
connect_bd_net -net I2C_RESET_peripheral_aresetn [get_bd_pins I2C_RESET/peripheral_aresetn] [get_bd_pins PL_I2C/s_axi_aresetn]
connect_bd_net -net Net [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins CM_SPI/ext_spi_clk] [get_bd_pins PL_I2C/s_axi_aclk] [get_bd_pins I2C_RESET/slowest_sync_clk]
...
connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins PL_I2C/iic2intc_irpt] [get_bd_pins xlconcat_0/In0]
connect_bd_net -net axi_intc_0_irq [get_bd_pins INTERUPTS/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_pins CM_SPI/io0_o] [get_bd_ports CM_DIN]
connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins CM_SPI/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_pins CM_SPI/sck_o] [get_bd_ports CM_SCLK]
connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_pins CM_SPI/ss_o] [get_bd_ports CM_CSn]
connect_bd_net -net eth_rx_n_0_1 [get_bd_ports RX_GTH_n] [get_bd_pins DAPHNE3/eth_rx_n]
connect_bd_net -net eth_rx_p_0_1 [get_bd_ports RX_GTH_p] [get_bd_pins DAPHNE3/eth_rx_p]
connect_bd_net -net eth_clk_n_0_1 [get_bd_ports eth_clk_n] [get_bd_pins DAPHNE3/eth_clk_n]
connect_bd_net -net eth_clk_p_0_1 [get_bd_ports eth_clk_p] [get_bd_pins DAPHNE3/eth_clk_p]
connect_bd_net -net fan_tach_0_1 [get_bd_ports fan_tach] [get_bd_pins DAPHNE3/fan_tach]
connect_bd_net -net io1_i_0_1 [get_bd_ports CM_DOUT] [get_bd_pins CM_SPI/io1_i]
connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins SYSTEM_RESET/peripheral_aresetn] [get_bd_pins CM_SPI/s_axi_aresetn] [get_bd_pins INTERUPTS/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins DAPHNE3/FRONT_END_S_AXI_ARESETN] [get_bd_pins DAPHNE3/SPY_BUF_S_S_AXI_ARESETN] [get_bd_pins DAPHNE3/END_P_S_AXI_ARESETN] [get_bd_pins DAPHNE3/SPI_DAC_S_AXI_ARESETN] [get_bd_pins DAPHNE3/AFE_SPI_S_AXI_ARESETN] [get_bd_pins DAPHNE3/TRIRG_S_AXI_ARESETN] [get_bd_pins DAPHNE3/STUFF_S_AXI_ARESETN] [get_bd_pins DAPHNE3/OUTBUFF_S_AXI_ARESETN] [get_bd_pins DAPHNE3/MUX_S_AXI_ARESETN]
...
connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins INTERUPTS/intr]
connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins SYSTEM_RESET/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins CM_SPI/s_axi_aclk] [get_bd_pins INTERUPTS/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins DAPHNE3/FRONT_END_S_AXI_ACLK] [get_bd_pins DAPHNE3/SPY_BUF_S_S_AXI_ACLK] [get_bd_pins DAPHNE3/END_P_S_AXI_ACLK] [get_bd_pins DAPHNE3/SPI_DAC_S_AXI_ACLK] [get_bd_pins DAPHNE3/AFE_SPI_S_AXI_ACLK] [get_bd_pins DAPHNE3/TRIRG_S_AXI_ACLK] [get_bd_pins DAPHNE3/STUFF_S_AXI_ACLK] [get_bd_pins DAPHNE3/OUTBUFF_S_AXI_ACLK] [get_bd_pins DAPHNE3/MUX_S_AXI_ACLK]
...
connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn1 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn1] [get_bd_pins I2C_RESET/ext_reset_in]
...
assign_bd_address -offset 0x98000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_7 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/TRIRG_S_AXI/reg0] -force
assign_bd_address -offset 0x94000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_8 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/STUFF_S_AXI/reg0] -force
assign_bd_address -offset 0x9C000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PL_I2C/S_AXI/Reg] -force
assign_bd_address -offset 0x9C010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs INTERUPTS/S_AXI/Reg] -force
assign_bd_address -offset 0x9C020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs CM_SPI/AXI_LITE/Reg] -force

# create PFM attributes
set_property PFM_NAME {xilinx:k26c:name:0.0} [get_files [current_bd_design].bd]
set_property PFM.AXI_PORT {M_AXI_HPM1_FPD { memport "M_AXI_GP" sptag "" memory "" is_range "false" } S_AXI_HP0_FPD { memport "S_AXI_HP" sptag "HP0" memory "" is_range "false" } S_AXI_HP1_FPD { memport "S_AXI_HP" sptag "HP1" memory "" is_range "false" } S_AXI_HP2_FPD { memport "S_AXI_HP" sptag "HP1" memory "" is_range "false" } S_AXI_HP3_FPD { memport "S_AXI_HP" sptag "HP3" memory "" is_range "false" } S_AXI_HPC0_FPD { memport "S_AXI_HPC" sptag "HPC0" memory "" is_range "false" } S_AXI_HPC1_FPD { memport "S_AXI_HPC" sptag "HPC1" memory "" is_range "false" } S_AXI_LPD { memport "MIG" sptag "" memory "" is_range "false" } } [get_bd_cells /zynq_ultra_ps_e_0]
set_property PFM.CLOCK {pl_clk0 {id "0" is_default "true" proc_sys_reset "/SYSTEM_RESET" status "fixed" freq_hz "99999001"}} [get_bd_cells /zynq_ultra_ps_e_0]
